          ...
          <div className="max-w-2xl py-40 mx-auto">
            ...
            <div className="text-center">
              ...
              <p className="mt-4 text-base font-medium text-gray-400 text-pretty ">
                Your privacy matters to us. At Earn 4u, we are committed to protecting your personal information and ensuring a safe and secure trading experience.

              </p>
              <div className="flex items-center justify-center mt-10 text-white gap-x-6">
                <Link to="/" className="px-8 py-2 rounded-full hover:text-green-100 bg-pink-600/35 hover:scale-105">Home</Link>
                <MdKeyboardDoubleArrowRight className="text-xl" />
                <Link to="/privacy" className="px-8 py-2 rounded-full hover:text-green-100 bg-pink-600/35 hover:scale-105">Privacy</Link>
              </div>
            </div>
          </div>
        </div>
