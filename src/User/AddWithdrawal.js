...
export default function UserAddWithdrawal() {
  ...
  function handleWithdrawalButton() {
    ...
    if (!allowedDays.includes(today)) {
      alert("Withdrawals are only allowed on the 1st, 11th, or 21st of the month.");
      return;
    }
  ...
  return (
    ...
    <div className="m-3 p-4 bg-[#111c54c7]">
      <div className="items-center justify-between w-full mb-3 lg:flex sm:flex ">
        <div className="mb-2">
          <h3 className="text-lg font-semibold text-gray-200">Withdraw Request </h3>
          <p className="text-lg text-slate-300">Overview of the Withdraw Request.</p>
        </div>
        <div className="">
          <div className="relative flex max-w-full gap-2 sm:gap-5">
            ...
            <button className="px-2 text-2xl  border border-gray-400 rounded-md text-gray-100 bg-[#569182c7]" onClick={()=>setDetail(true)}> <CgDetailsMore/></button>
      ...
      <div className="grid grid-cols-2 gap-2 mb-4 sm:grid-cols-4">
          <button
              ...
              className="block px-3 py-2 text-base font-semibold text-center text-white bg-[#569182c7] rounded-sm shadow-sm hover:bg-[#0f1b61a8] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
            >
              Withdrawal Working
            </button>
            ...
            <button
              ...
              className="block px-3 py-2 text-base font-semibold text-center text-white bg-[#7e66c5b3] rounded-sm shadow-sm hover:bg-[#0f1b61a8] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
            >
              Withdrawal ROI
            </button>
              ...
              <thead className="text-gray-100 ">
                <tr>
                  <th className="p-2 border-b md:p-4 border-slate-200 ">
                    <p className="text-xs font-normal leading-none md:text-lg">E-Mail</p>
                  </th>
                  <th className="p-2 border-b md:p-4 border-slate-200 ">
                    <p className="text-xs font-normal leading-none md:text-lg">Amount</p>
                  </th>
                  <th className="p-2 border-b md:p-4 border-slate-200 ">
                    <p className="text-xs font-normal leading-none md:text-lg">Status</p>
                  </th>
                  <th className="p-2 border-b md:p-4 border-slate-200 ">
                    <p className="text-xs font-normal leading-none md:text-lg">Request</p>
                  </th>
                  <th className="p-2 border-b md:p-4 border-slate-200 ">
                    <p className="text-xs font-normal leading-none md:text-lg">Type</p>
                  </th>
                  <th className="p-2 border-b md:p-4 border-slate-200 ">
                    <p className="text-xs font-normal leading-none md:text-lg">Action at</p>
                  </th>
                </tr>
              </thead>
