  ...
  return (
    <>
      <div className=" text-gray-900  relative z-10 ">
        ...
        <div className=" px-4 relative z-10  lg:max-w-7xl lg:px-3 ">
          <div className="pt-4">
            <h2 className="flex   items-center gap-2 font-medium text-white text-lg">
              Welcome {singleuser?.fullname ? singleuser?.fullname : ""}
              <CheckCircleIcon
                aria-hidden="true"
                className="mr-1.5 h-5 w-5 flex-shrink-0 text-[#fff]"
              />
              <span className="text-[#fff] text-lg">Dashboard</span>
            </h2>
          </div>
          <div className="grid lg:grid-cols-4 sm:grid-cols-2  grid-cols-1 gap-x-4 gap-y-10   mt-10">
            {stat.map((item, i) => (
              ...
              >
                ...
                <p
                  className={`text-sm font-medium pb-4 px-4 ${item.iconColor} `}
                >
                ...
                <div className="grid grid-cols-1  lg:grid-cols-2 gap-4 ">
                  {cardData.map((card) => (
                    ...
                    >
                      ...
                      {/* Percentage Change */}
                      <p className="text-sm font-medium pb-4 px-4 text-gray-200">
                        {card.percentage}% vs last month
                      </p>
                    </div>
                  ))}
                </div>
